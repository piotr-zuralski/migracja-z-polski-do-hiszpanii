...
<xsl:stylesheet version="1.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="sitemap:urlset">
        ...
        <div id="intro">
            <p>
                <a rel="external nofollow" href="http://sitemaps.org">XML Sitemap</a> for search engines which follow the XML Sitemap standard (like Ask.com, Bing, Google and Yahoo).
            </p>
        </div>
        <div id="content">
            <table cellpadding="5">
